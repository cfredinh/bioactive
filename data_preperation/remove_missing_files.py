...
path_new_csv = "/path/to/new_training.csv" # the new csv used for training only containing data points where the images are known to have been downloaded and pre_processed
